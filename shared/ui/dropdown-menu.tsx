...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex cursor-default items-center gap-1.5 whitespace-nowrap rounded-md px-1.5 py-1 text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground not-data-[variant=destructive]:focus:**:text-accent-foreground data-inset:ps-7 data-[variant=destructive]:text-destructive data-[variant=destructive]:[&[data-highlighted]]:bg-destructive data-[variant=destructive]:[&[data-highlighted]]:text-white dark:data-[variant=destructive]:[&[data-highlighted]]:bg-destructive/80 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 data-[variant=destructive]:[&[data-highlighted]]:*:[svg]:text-white data-[variant=destructive]:*:[svg]:text-destructive",
        className
      )}
      {...props}
    />
