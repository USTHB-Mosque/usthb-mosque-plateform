...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_study_year" AS ENUM('1', '2', '3', '4', '5');
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'user');
  CREATE TYPE "public"."enum_users_verification_status" AS ENUM('pending_verification', 'verified', 'rejected');
  CREATE TYPE "public"."enum_books_type" AS ENUM('aqidah', 'fiqh', 'hadith', 'tafsir', 'sirah', 'quranic-sciences', 'dawah', 'history', 'philosophy', 'mathematics', 'physics', 'chemistry', 'biology', 'engineering', 'economics', 'language', 'other');
  CREATE TYPE "public"."enum_books_category" AS ENUM('religious', 'scientific');
  CREATE TYPE "public"."enum_books_language" AS ENUM('fr', 'ar', 'en');
  CREATE TYPE "public"."enum_activities_type" AS ENUM('aqidah', 'fiqh', 'hadith', 'tafsir', 'sirah', 'language', 'other');
  CREATE TYPE "public"."enum_articles_type" AS ENUM('aqidah', 'fiqh', 'hadith', 'other');
  ...
  CREATE TABLE "users" (
  	...
  	"verification_status" "enum_users_verification_status" DEFAULT 'pending_verification',
  	...
  	"notification_preferences_loan_requests" boolean DEFAULT true,
  	"notification_preferences_activity_registrations" boolean DEFAULT true,
  	"notification_preferences_loan_extensions" boolean DEFAULT true,
  	"notification_preferences_loan_return_reminder" boolean DEFAULT true,
  ...
  CREATE TABLE "books" (
  	...
  	"category" "enum_books_category" DEFAULT 'religious',
  ...
  CREATE TABLE "activities_target_audience" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar
  ...
  CREATE TABLE "activities" (
  	...
  	"location" varchar,
  	"supervisor" varchar,
  	"open_for_registration" boolean DEFAULT false,
  ...
  ALTER TABLE "users" ADD CONSTRAINT "users_verification_document_id_media_id_fk" FOREIGN KEY ("verification_document_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "activities_target_audience" ADD CONSTRAINT "activities_target_audience_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."activities"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "book_favorites" ADD CONSTRAINT "book_favorites_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "book_favorites" ADD CONSTRAINT "book_favorites_book_id_books_id_fk" FOREIGN KEY ("book_id") REFERENCES "public"."books"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_book_favorites_fk" FOREIGN KEY ("book_favorites_id") REFERENCES "public"."book_favorites"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "users_verification_document_idx" ON "users" USING btree ("verification_document_id");
  CREATE INDEX "users_updated_at_idx" ON "users" USING btree ("updated_at");
  CREATE INDEX "users_created_at_idx" ON "users" USING btree ("created_at");
  CREATE UNIQUE INDEX "users_email_idx" ON "users" USING btree ("email");
  CREATE INDEX "media_is_private_idx" ON "media" USING btree ("is_private");
  ...
  CREATE INDEX "activities_target_audience_order_idx" ON "activities_target_audience" USING btree ("_order");
  CREATE INDEX "activities_target_audience_parent_id_idx" ON "activities_target_audience" USING btree ("_parent_id");
  ...
  CREATE INDEX "book_favorites_user_idx" ON "book_favorites" USING btree ("user_id");
  CREATE INDEX "book_favorites_book_idx" ON "book_favorites" USING btree ("book_id");
  CREATE INDEX "book_favorites_updated_at_idx" ON "book_favorites" USING btree ("updated_at");
  CREATE INDEX "book_favorites_created_at_idx" ON "book_favorites" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_book_favorites_id_idx" ON "payload_locked_documents_rels" USING btree ("book_favorites_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "activities_target_audience" CASCADE;
  ...
  DROP TABLE "book_favorites" CASCADE;
  ...
  DROP TYPE "public"."enum_users_verification_status";
