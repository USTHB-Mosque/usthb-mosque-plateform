...
const activityData = [
  ...
  { title: 'ملتقى العقيدة الإسلامية', type: 'aqidah' as const, location: 'المكتبة المركزية', day: 9 },
  { title: 'ورشة لغة عربية للمبتدئين', type: 'language' as const, location: 'غرفة 201', day: 11 },
  { title: 'حلقة قراءة الحديث الشريف', type: 'hadith' as const, location: 'المسجد الأكبر', day: 13 },
  { title: 'محاضرة في السيرة النبوية', type: 'sirah' as const, location: 'قاعة المحاضرات', day: 16 },
  ...
  for (const act of activityData) {
    ...
    await payload.create({
      ...
      data: {
        ...
        longDescription: { root: { type: 'root', children: [{ type: 'text', version: 1, text: act.title, format: 0, style: '', indent: 0 }], direction: 'rtl', format: '', indent: 0, version: 1 } } as any,
