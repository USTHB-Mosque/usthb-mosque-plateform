// BookType/BookCategory are the shared vocabulary for both this config
// (collections/Book.ts field options) and the frontend library feature
// (features/library/types.ts), so they live here rather than in either layer.
