...
const activitiesData = [
  {
    ...
    shortDescription: 'حلقات أسبوعية لتحفيظ القرآن الكريم بمسجد الجامعة، مفتوحة لجميع المستويات مع مراجعة مستمرة.',
    longDescription: richText([
      h('عن الحلقة', 'h2'),
      p('تُقام حلقات تحفيظ القرآن الكريم أسبوعياً في مسجد الجامعة، وتهدف إلى مساعدة الطلاب على حفظ القرآن الكريم وتثبيته في الذاكرة. تُفتح الحلقات لجميع الطلاب بغض النظر عن مستواهم.'),
      p('تبدأ الحلقة بمراجعة ما حُفظ من قبل، ثم التلامس على الآيات الجديدة مع شرح المعاني والتجويد.'),
      h('الفوائد', 'h2'),
      ul([
    ...
    targetAudience: [
      { name: 'جميع طلاب الجامعة' },
      { name: 'من يريد تعلم القرآن' },
    ],
  ...
  },
  {
    ...
    shortDescription: 'دورة مكثفة في أصول الفقه الإسلامي تشمل القواعد الأصولية والاستنباط والمنهج العلمي.',
    longDescription: richText([
      h('محتوى الدورة', 'h2'),
      p('تتناول هذه الدورة أهم أصول الفقه الإسلامي من مصادر التشريع، وقواعد الاستنباط، والمقاصد. الهدف هو تمكين الطلاب من فهم أصول الحكم الشرعي.'),
      h('المحاضرات', 'h2'),
      ul([
  ...
  },
  {
    ...
    shortDescription: 'حلقة شهرية لدراسة السيرة النبوية الشريفة مع التركيز على الدروس والعبر المستفادة.',
    longDescription: richText([
      h('أهداف الحلقة', 'h2'),
      p('تهدف هذه الحلقة إلى تعريف الطلاب بالسيرة النبوية الشريفة من مولده عليه السلام إلى وفاته، مع استخراج الدروس والعبر العملية.'),
    ...
    targetAudience: [
      { name: 'جميع طلاب الجامعة' },
      { name: 'من يريد تعلم السيرة' },
    ],
    location: 'مسجد الجامعة — صالة الاجتماعات',
    supervisor: 'الشيخ عبد العزيز بن باز',
    schedules: [
      { dateAndTime: dateTimeFromNow(10, 16) },
      { dateAndTime: dateTimeFromNow(40, 16) },
    ],
    openForRegistration: true,
  ...
  },
  {
    ...
    longDescription: richText([
      h('محتوى الورشة', 'h2'),
      p('ورشة عملية تقدم لطلاب تعلم أحكام التجويد الأساسية من مخارج الحروف وصفاتها، والغنّ، والمدود.'),
    ...
    targetAudience: [
      { name: 'من يريد تعلم التجويد' },
      { name: 'الطلاب المبتدئون' },
    ],
  ...
  },
  {
    ...
    longDescription: richText([
      h('المحاضرة', 'h2'),
      p('تتناول هذه المحاضرة أهمية العقيدة الصحيحة في بناء الشخصية المسلمة، وكيفية مواجهة التحديات المعاصرة بالاستناد إلى المبادئ الإسلامية.'),
  ...
  },
  {
    ...
    longDescription: richText([
      h('نظرة عامة', 'h2'),
      p('دورة شاملة لتعلم اللغة العربية للمبتدئين، تبدأ من الحروف وتصل إلى القراءة والكتابة والمحادثة الأساسية.'),
      ul([
  ...
  },
  {
    ...
    longDescription: richText([
      h('قواعد المسابقة', 'h2'),
      p('تُعقد المسابقة السنوية لاختبار الطلاب في حفظ القرآن الكريم، وتشمل عدة مراحل من المراجعة والاختبار.'),
      ul([
    ...
    targetAudience: [
      { name: 'طلاب الجامعة الحافظون للقرآن' },
      { name: 'من لديه قدرة على الحفظ' },
    ],
    location: 'مسجد الجامعة — القاعة الكبرى',
    supervisor: 'الشيخ عبد الرحمن السعدي',
  ...
  },
  {
    ...
    type: 'other' as Activity['type'],
    shortDescription: 'ورشة عملية لتعلم فن الخط العربي التقليدي مع التدريب على أنواع الخطوط المختلفة.',
    longDescription: richText([
      h('الخط العربي كفن إسلامي', 'h2'),
      p('يُعد الخط العربي من أبرز الفنون الإسلامية، وقد تطور عبر العصور ليصبح فناً متكاملاً. تقدم هذه الورشة فرصة لتعلم أساسيات الخط العربي.'),
      ul([
    ...
    targetAudience: [
      { name: 'من يهتم بالفنون الإسلامية' },
      { name: 'جميع طلاب الجامعة' },
    ],
  ...
  },
  {
    ...
    type: 'aqidah' as Activity['type'],
    shortDescription: 'دورة شاملة في علم العقيدة الإسلامية تبدأ من الأصول ثم تتعمق في المذاهب والمسائل الخلافية.',
    longDescription: richText([
      h('نظرة عامة على الدورة', 'h2'),
      p('دورة شاملة تغطي أهم مسائل العقيدة الإسلامية من التوحيد وأقسامه، والإيمان بالملائكة والكتب والرسل واليوم الآخر وال والقدر.'),
      h('محاور الدورة', 'h2'),
      ul([
    ...
    targetAudience: [
      { name: 'طلاب العلوم الإسلامية' },
      { name: 'من يريد تعميق معرفته بالعقيدة' },
    ],
    location: 'قاعة المحاضرات — المبنى الرئيسي',
    supervisor: 'الشيخ عبد العزيز بن باز',
    schedules: [
  ...
  },
  {
    ...
    type: 'language' as Activity['type'],
    shortDescription: 'حلقة أكاديمية لدراسة الترجمة من العربية إلى الإنجليزية والعكس مع التركيز على النصوص الشرعية.',
    longDescription: richText([
      h('أهداف الحلقة', 'h2'),
      p('حلقة أكاديمية متقدمة لتطوير مهارات الترجمة من وإلى الإنجليزية مع التركيز على النصوص الشرعية والأدبية.'),
      ul([
    ...
    supervisor: 'الشيخ محمد بن صالح المنجد',
    schedules: [
      { dateAndTime: dateTimeFromNow(8, 13) },
      { dateAndTime: dateTimeFromNow(15, 13) },
    ],
  ...
  },
  {
    ...
    shortDescription: 'مؤتمر أكاديمي يستعرض مناهج دراسة الحديث الشريف من صحيح وحسن وضعيف مع التطبيق العملي.',
    longDescription: richText([
      h('محاور المؤتمر', 'h2'),
      p('مؤتمر أكاديمي يجمع طلاب العلم الشرعي لاستعراض مناهج دراسة الحديث الشريف وتطبيقاتها المعاصرة.'),
      ul([
    ...
    supervisor: 'الشيخ محمد ناصر الدين الألباني',
    schedules: [
      { dateAndTime: dateTimeFromNow(30, 9) },
      { dateAndTime: dateTimeFromNow(31, 9) },
    ],
    openForRegistration: true,
  ...
  },
  {
    ...
    type: 'fiqh' as Activity['type'],
    shortDescription: 'حلقة أسبوعية لقراءة ودراسة كتاب "بداية المجтهد" لابن رشد مع مناقشة المسائل الفقهية.',
    longDescription: richText([
      h('عن الكتاب', 'h2'),
      p('كتاب "بداية المجتهد" من أهم الكتب الفقهية المختصرة، يعرض المسائل الخلافية بين المذاهب الأربعة بشكل مconcise وواضح.'),
      h('منهج الحلقة', 'h2'),
      ul([
  ...
  },
  {
    ...
    type: 'other' as Activity['type'],
    shortDescription: 'نشاط خيري أسبوعي لتحضير و distribute الوجبات للعائلات المحتاجة بالمنطقة المحيطة بالجامعة.',
    longDescription: richText([
      h('الهدف من النشاط', 'h2'),
      p('نشاط خيري تطوعي يهدف إلى تحضير و distributing الوجبات الغذائية للعائلات المحتاجة بالمنطقة المحيطة بالجامعة.'),
      h('كيفية المشاركة', 'h2'),
      ul([
  ...
  },
  {
    ...
    targetAudience: [
      { name: 'طلاب العلم الشرعي' },
      { name: 'من يريد الإعداد لل خطابة' },
    ],
    location: 'مسجد الجامعة — القاعة الكبرى',
    supervisor: 'الشيخ محمد بن صالح العثيمين',
    schedules: [
