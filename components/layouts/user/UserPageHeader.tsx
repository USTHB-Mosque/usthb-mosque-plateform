...
const UserPageHeader: React.FC<UserPageHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 -ms-px flex items-center justify-between gap-4 border-b border-border bg-background-2 px-4 py-3 sm:px-6 lg:rounded-es-xl">
