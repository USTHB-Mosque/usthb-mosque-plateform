...
const images = [
  {
    src: '/static/images/ramadan.jpg',
    alt: 'فعالية رمضانية',
    className: 'lg:col-span-2 lg:row-span-2 h-[516px] hidden lg:block',
  },
  ...
  return (
    ...
    >
      ...
      <p className="text-lg text-muted-foreground mb-12">
        لحظات توثق أنشطة المسجد وفعالياته المختلفة.
      </p>
      ...
      <Dialog open={!!selectedImage} onOpenChange={(open) => !open && setSelectedImage(null)}>
        <DialogContent
          ...
          className="max-w-4xl p-0 overflow-hidden bg-transparent border-none shadow-none ring-0"
        >
